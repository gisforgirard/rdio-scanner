...
export class RdioScannerSearchComponent implements OnDestroy {
	...
	private getSelectedTalkgroup(): RdioScannerTalkgroup | undefined {
		...
		/*
		if (system) {
			// search array talkgroup
			// looking for label==the same one that's selected
			// to me this seems literally retarded when the talkgroup id is in the form
			// and why anyone would do this is beyond my imagination
